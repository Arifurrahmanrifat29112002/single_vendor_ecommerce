@php
 ...
 $deliverd_count = App\Models\Order::where('delivery_status','deliverd')->count();
 $processing_count = App\Models\Order::where('delivery_status','processing')->count();
@endphp
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-9">
                                <div class="d-flex align-items-center align-self-start">
                                    <h3 class="mb-0">{{ $deliverd_count }}</h3>
